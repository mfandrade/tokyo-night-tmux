...
#+--- Bars RIGHT ---+
tmux set -g status-right "$wb_git_status$git_status$current_path$cmus_status$netspeed$date_and_time$battery_status #[fg=${THEME[blue]},bg=${THEME[background]},bold] #[fg=${THEME[bblack]},bg=${THEME[blue]},bold] #S #{?client_prefix,󰠠 ,#[dim]󰤂 }#[bold,nodim]"
